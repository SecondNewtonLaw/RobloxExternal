...
const char *Roblox::ReadString(std::uintptr_t address, int suspectedSize) {
...
BYTE Roblox::ReadByte(std::uintptr_t address) {
    BYTE buf = {};
...
WORD Roblox::ReadWord(std::uintptr_t address) {
    WORD buf = {};
...
DWORD Roblox::ReadDword(std::uintptr_t address) {
    DWORD buf = {};
...
DWORD64 Roblox::ReadQword(std::uintptr_t address) {
    SIZE_T readMemory = 0;
    DWORD64 buf = {};
...
DWORD64 Roblox::ReadDword64(std::uintptr_t address) {
    return this->ReadQword(address);
}

void Roblox::Initialise() {
    // TODO: Write.
...
DWORD64 Roblox::GetLocalPlayer(DWORD64 playerServiceAddress) {
    return this->ReadQword(playerServiceAddress + oxorany(0x240));
}

std::uintptr_t Roblox::GetDataModel() {
...
[[maybe_unused]] HANDLE Roblox::GetRobloxHandle() {
